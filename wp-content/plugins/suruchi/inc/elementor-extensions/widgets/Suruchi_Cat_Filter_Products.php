...
class Suruchi_Cat_Filter_Products extends Widget_Base
{

	public function get_name()
	{
		return 'ic-cat-filter';
	}

	public function get_title()
	{
		return __('Category Filter', 'suruchi');
	}
	...
	protected function register_controls()
	{
		...
		$this->add_control(
			'title',
			[
				'label'       => __('Category filter', 'suruchi'),
			...
			<div class="container-fluid">
				...
				<ul class="product__tab--one product__tab--primary__btn d-flex justify-content-center mb-50">
					...
					foreach ($product_cat as $key => $cat) {
						// var_dump($key);
					?>
						<li class="product__tab--primary__btn__list <?php echo (1 === $key) ? 'active' : ' ' ?>" data-toggle="tab" data-target="#<?php echo esc_attr($cat->slug); ?>"><?php echo $cat->name; ?></li>
					<?php
					}
					?>
				...
				<div class="tab_content">
					...
					?>
						<div id="<?php echo esc_attr($cat->slug); ?>" class="tab_pane <?php echo (0 === $i) ? 'active show' : 'fade' ?>">
							<div class="product__section--inner">
								<div class="row row-cols-xl-5 row-cols-lg-4 row-cols-md-3 row-cols-2 mb--n30">
									<?php
									$products = new WP_Query($psot_arg);
												...
												<div class="product__items ">
													<div class="product__items--thumbnail">
														<a class="product__items--link" href="product-details.html">
															...
															<img class="product__items--img product__secondary--img" src="<?php echo get_template_directory_uri(); ?>/assets/img/product/product2.png" alt="product-img">
														</a>
													...
													<div class="product__items--content">
														<span class="product__items--content__subtitle"><?php $cat->name; ?></span>
														<h3 class="product__items--content__title h4"><a href="product-details.html">title</a></h3>
...
Plugin::instance()->widgets_manager->register(new Suruchi_Cat_Filter_Products());
